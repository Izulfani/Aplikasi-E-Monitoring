...
<!--===============================================================================================-->	
	<link rel="stylesheet" type="text/css" href="aassets1/vendor/css-hamburgers/hamburgers.min.css">
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(images0/bg-01.jpg);">
					<span class="login100-form-title-1">
						Login Teknisi
					</span>
				</div>

				<form class="login100-form validate-form" method="POST" action="proses-login-teknisi.php">
...
<!--===============================================================================================-->
	<script src="assets1/jquery/jquery-3.2.1.min.js"></script>
<!--===============================================================================================-->
