                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                         ...
                         <?php 
                        include "../config/koneksi.php";
                        $sql = mysqli_query($koneksi, "SELECT * FROM admin WHERE id_admin='$_SESSION[id_admin]'");
                        ?>
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td><a href="edit-admin.php?id_admin=<?php echo $row['id_admin']; ?>" class="nav-icon fas fa-edit"></a> 
